...
namespace TampaIoT.TankBot.Core.Protocols
{
    ...
    /// <summary>
    /// Class to take an array of bytes and parse out the message, once a message has been received it is pass upwards with an event.
    /// </summary>
